...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-rh5g2ju.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-rh5g2ju.containers.anotherwebservice.com/
...
```
git clone git@github.com:shirsevom/container-rh5g2ju.git
cd container-rh5g2ju
```
...
```
docker attach container-rh5g2ju
```
